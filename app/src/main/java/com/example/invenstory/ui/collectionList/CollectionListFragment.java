    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        collectionListViewModel.getCollectionList().observe(getViewLifecycleOwner(), collection -> {
            ...
            listView.setOnItemClickListener((parent, view, position, id) -> {
                ...
                //I will refactor this so it looks prettier in a future update, it just requires lots of rebuilding in many classes
                //https://developer.android.com/guide/navigation/navigation-pass-data
                //This link shows how to pass additional data between fragments. Note we are using "Safe Args" to do this
